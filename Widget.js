define([
	...
	return declare([BaseWidget], {
		...
		_bindEvents: function () {
			...
			this.own(on(this._jimuLayerInfos,
					'layerInfosChanged',
					lang.hitch(this, 'showChanges2')));

			this.own(on(this._jimuLayerInfos,
					'layerInfosRendererChanged',
					lang.hitch(this, 'showChanges3')));
		...
		refreshLayers: function () {
			console.warn('reporting changes - layerInfosIsShowInMapChanged');
			var validate = false;
			this._jimuLayerInfos.traversal(lang.hitch(this, function (layerInfo) {
		...
		_disableSelects: function () {
			// registry.byId("layers").setAttribute('disabled', true);
			if (this.layerItems) {
				this.layerItems.set('disabled', true);
				if (this.thematicLayerItems) {
					this.thematicLayerItems.set('disabled', true);
					if (this.subLayerItems) {
						this.subLayerItems.set('disabled', true);
						if (this.fieldItems) {
							this.fieldItems.set('disabled', true);
							if (this.txtBreaks && this.btnSubmit) {
								this.txtBreaks.set('disabled', true);
		...
		showChanges2: function () {
			console.warn('reporting changes - layerInfosChanged');
			console.info(this._jimuLayerInfos);
			console.info('layerInfoArray');
			console.log(this._jimuLayerInfos.getLayerInfoArray());
		},
		showChanges3: function () {
			console.warn('reporting changes - layerInfosRendererChanged');
			console.info(this._jimuLayerInfos);
			console.info('layerInfoArray');
			console.log(this._jimuLayerInfos.getLayerInfoArray());
		},
		...
		createLegend: function () {
			console.log(this.parameters.layer);
